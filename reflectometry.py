'''
Reads in the outputs of the teqc +plot on a day series then
'''
import numpy as np
...
def plot_multipath(azimuth, elev, snr):
    key = 'G01'
...
def plot_lombscargle(el, snvolts):
...
if __name__ == '__main__':
    ...
    el, snvolts = plot_multipath(azimuths, elev, snr)
    plot_lombscargle(el, snvolts)
